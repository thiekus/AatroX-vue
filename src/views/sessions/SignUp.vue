        ...
        <div class="container-session-v1 max-w-2xl">
            <BaseCard no-padding class="overflow-hidden">
                <div class="grid grid-cols-12">
                    ...
                    >
                        <div
                            class="block justify-center items-center flex-col h-full px-4 py-2 lg:flex"
                        >
                            <svg
                            ...
                            >
                                <i
                                    class="i-Mail-with-At-Sign align-middle mr-2"
                                ></i
                                >Sign Up with Email
                            </BaseBtn>
                            <BaseBtn
                                block
                                rounded
                                class="mb-3 border border-red-500 bg-gray-100 text-red-500 hover:bg-red-500 hover:text-white"
                            >
                                <i class="i-Google-Plus align-middle mr-2"></i
                                >Sign Up with Google
                            </BaseBtn>
                            <BaseBtn
                                block
                            ...
                            >
                                <i class="i-Facebook-2 align-middle mr-2"></i
