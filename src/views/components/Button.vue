...
const colorsOutlined = [
    ...
    {
        colorName:
            'border border-light text-light hover:bg-light hover:text-white',
        theme: 'Light',
    },
    {
        colorName:
...
<template>
    <div class="container mx-auto">
        <Breadcrumb parent-title="Button" sub-parent-title="Buttons" />
            ...
            <div class="grid md:grid-cols-2 sm:grid-cols-1 gap-4">
                ...
                <div>
                    <BaseCard>
                        ...
                        <div>
                            <BaseBtn class="mb-3 mr-3 bg-primary text-white">
                                <i class="i-Gear-2"></i>
                            </BaseBtn>
                            <BaseBtn class="mb-3 mr-3 bg-success text-white">
